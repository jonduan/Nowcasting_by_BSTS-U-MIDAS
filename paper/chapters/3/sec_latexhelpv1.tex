...
\section{How to Number Pages}
 ...
 \texttt{
    \begin{tabular}{ll}
        \textrm{\textbf{Numbering Style}}   & \textrm{\textbf{Output}} \\
        $\backslash$pagenumbering\{arabic\} & 1, 2, 3, ...\\
        $\backslash$pagenumbering\{roman\}  & i, ii, iii, ...\\
        $\backslash$pagenumbering\{alph\}   & a, b, c, ...\\
        $\backslash$pagenumbering\{Roman\}  & I, II, III, ...\\
        $\backslash$pagenumbering\{Alph\}   & A, B, C, ...
    \end{tabular}
 }
